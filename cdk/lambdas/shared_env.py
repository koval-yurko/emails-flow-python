...
_base_envs = {
  ...
  "OTEL_PYTHON_DISABLED_INSTRUMENTATIONS": "redis,grpc,jinja2,starlette,tornado,django,flask,fastapi,falcon,mysql,pymongo,pymysql,pyramid,pymemcache,psycopg2",
